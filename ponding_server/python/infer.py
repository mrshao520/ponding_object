...
if __name__ == "__main__":
    ...
    with open(file='./short.txt', encoding='utf-8') as shortfile:
        short_list = shortfile.readlines()
        
    with open(file='./long.txt', encoding='utf-8') as longfile:
        long_list = longfile.readlines()
        
    resluts = uie.predict(short_list, return_dict=True)
    for i in resluts:
        print(i)
        print()
        
    resluts = uie.predict(long_list, return_dict=True)
    for i in resluts:
        print(i)
        print()
