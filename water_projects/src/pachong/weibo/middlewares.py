...
#     with open(current_path + "/documents/weibo_cookie.json", 'r', encoding='utf-8') as f:
#             load_dict = json.load(f)   
            
#     cookies_str = load_dict['weibo_cookie']
#     cookies_dict = {}
...
def get_cookies_dict():
    with open(current_path + "/documents/weibo.json", 'r') as file:
